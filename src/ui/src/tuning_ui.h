...
public:
    ...
    void setupUi(QMainWindow *ControlSysUI)
    {
        ...
        horizontalLayoutWidget->setGeometry(QRect(20, 50, 415, 431));
        ...
        refreshButton->setGeometry(QRect(90, 10, 99, 27));
        tabWidget = new QTabWidget(centralwidget);
        tabWidget->setObjectName(QStringLiteral("tabWidget"));
        tabWidget->setGeometry(QRect(450, 10, 551, 571));
        tab_3 = new QWidget();
        tab_3->setObjectName(QStringLiteral("tab_3"));
        telemetry_box = new QFrame(tab_3);
        telemetry_box->setObjectName(QStringLiteral("telemetry_box"));
        telemetry_box->setGeometry(QRect(0, 0, 531, 151));
        ...
        thruster_label_2->setFont(font1);
        ...
        thruster_label_3->setFont(font1);
        ...
        thruster_label_4->setFont(font1);
        ...
        thruster_label_5->setFont(font1);
        ...
        thruster_label_6->setFont(font1);
        ...
        thruster_label_7->setFont(font1);
        ...
        thruster_label_8->setFont(font1);
        ...
        thruster_label_9->setFont(font1);
        frame = new QFrame(tab_3);
        frame->setObjectName(QStringLiteral("frame"));
        frame->setGeometry(QRect(10, 170, 221, 231));
        ...
        disableButton->raise();
        tabWidget->raise();
        advanced_frame = new QFrame(tab_3);
        advanced_frame->setObjectName(QStringLiteral("advanced_frame"));
        advanced_frame->setGeometry(QRect(240, 170, 281, 231));
        ...
        controparam_frame = new QFrame(tab_3);
        controparam_frame->setObjectName(QStringLiteral("controparam_frame"));
        controparam_frame->setGeometry(QRect(20, 400, 531, 131));
    ...
    void retranslateUi(QMainWindow *ControlSysUI)
    {
        ...
        tabWidget->setTabText(tabWidget->indexOf(tab_3), QApplication::translate("ControlSysUI", "Tab 1", 0));
        tabWidget->setTabText(tabWidget->indexOf(tab_4), QApplication::translate("ControlSysUI", "Tab 2", 0));
